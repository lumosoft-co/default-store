    ...
    return (
        <div className="p-5 w-100 h-100 grid grid-cols-2 z-50 items-center">
            ...
            <div className="">
                ...
                <div className="flex flex-row">
                    <button className="cursor-pointer text-white" onClick={() => handleCartProductMutation(cartLineRemoveMutation, 1)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <button className="cursor-pointer z-50 text-white" onClick={() => handleCartProductMutation(cartLineAddMutation, 1)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
